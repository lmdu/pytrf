...
static PyMethodDef pytrf_etr_methods[] = {
	...
	{"as_gff", (PyCFunction)pytrf_etr_as_gff, METH_NOARGS, NULL},
...
static PyMemberDef pytrf_etr_members[] = {
	...
	{"motif", T_STRING, offsetof(pytrf_ETR, motif), READONLY},
